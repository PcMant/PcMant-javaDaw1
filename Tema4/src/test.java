...
public class test {
	...
	public static void main(String[] args) {
		...
		//Ejemplo toString()
		/*Permite obtener el nombre de la clase desde el cual fue invocado. Además
		 del nombre de la clase, devuelve el carácter @ y la representación
		 hexadecimal del código hash del objeto. 
		 */
